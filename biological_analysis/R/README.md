...
### 2. `dinucleotide_content_enrichment.R` — Dinucleotide content enrichment (Cliff's delta)

Computes per-dinucleotide Cliff's delta and AUROC from pre-computed frequency tables.

```bash
Rscript dinucleotide_content_enrichment.R \
