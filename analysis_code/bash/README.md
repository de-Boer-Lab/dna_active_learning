...
`sbatch scripts/bash/diNuclContent.sh Seq.noID.tsv diNuclContent.Seq.tsv`

### TF motifs scanning

`sbatch scripts/bash/memeFimoScan.sh Seq.fasta TF_MOTIFS.meme OUT_FOLDER BACKGROUND.txt`
